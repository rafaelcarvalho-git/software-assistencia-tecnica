...
def pendService(): #janela dos serviços pendentes
    if len(lista_servicos_pendentes)==0:
        ...
        servlb = Label(servicosPendents_screen, text="Serviços Pendentes", font="Arial 18", bg='#4141ff', fg='white').place(x=75,y=10)
        ...
        def infoServicoPend():
            try:
                ...
                rs = Label(infoPendent, text="R$:", font="Arial", bg='#4141ff', fg='white').place(x=200,y=92)
                clientesLabel = Label(infoPendent, text='Cliente:', font="Arial", bg='#4141ff', fg='white').place(x=55,y=130)           
                ...
                data = StringVar() 
                data.set(indiceData) 
                client_data = Entry(infoPendent, textvariable=data, font="Arial", bd=4, width=14, state=DISABLED).place(x=38,y=90)
                valor = StringVar() 
                valor.set(indiceValor)
                client_value = Entry(infoPendent, textvariable=valor, font="Arial", bd=4, width=14, state=DISABLED).place(x=230,y=90)
                service = StringVar()
                service.set(indiceServico)
                client_service = Entry(infoPendent, width=38, textvariable=service, bd=4, font="Arial", state=DISABLED).place(x=24,y=50)
                ...
                def fecharPendInfo():
                    infoPendent.destroy()
                okclbt = Button(infoPendent, text='Ok', width=10, command=fecharPendInfo, cursor='hand2').place(x=160,y=190)
                def oksvcclbt():
                    infoPendent.destroy()
        ...
        if len(lista_servicos_concluidos)==0:
            ...
            def infoServicConcluded():
                try:
                    ...
                    rs = Label(infoConcluded, text="R$:", font="Arial", bg='#4141ff', fg='white').place(x=200,y=92)
                    clientesLabel = Label(infoConcluded, text='Cliente:', font="Arial", bg='#4141ff', fg='white').place(x=55,y=130)
                    indice = listaconcludedServices.curselection()[0]
                    indiceData = lista_datas_servicos[indice]
                    indiceValor = lista_valores_servicos[indice]
                    indiceCliente = lista_nome_cliente[indice]
                    ...
                    data = StringVar() 
                    data.set(indiceData) 
                    client_data = Entry(infoConcluded, textvariable=data, font="Arial", bd=4, width=14, state=DISABLED).place(x=38,y=90)
                    valor = StringVar() 
                    valor.set(indiceValor)
                    client_value = Entry(infoConcluded, textvariable=valor, font="Arial", bd=4, width=14, state=DISABLED).place(x=230,y=90)
                    service = StringVar()
                    service.set(indiceServico)
                    client_service = Entry(infoConcluded, width=38, textvariable=service, bd=4, font="Arial", state=DISABLED).place(x=24,y=50)
                    clientes = lista_nome_cliente[indice]
                    ...
                    okclbt = Button(infoConcluded, text='Ok', width=10, command=fecharConcludInfo, cursor='hand2').place(x=160,y=190)
            def oksvcclbt():
                infoConcluded.destroy()
